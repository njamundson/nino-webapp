    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col items-center justify-center py-24 text-center">
        <div className="w-24 h-24 rounded-3xl bg-gradient-to-br from-[#F5F5F7] to-[#E8E8E8] border border-black/[0.06] flex items-center justify-center mb-6">
          <Sparkles size={40} className="text-[#C0C0C0]" />
        </div>
        ...
        <p className="text-[15px] text-[#8E8E93] max-w-md mb-8">
          Generate beautiful, on-brand images from text descriptions. 
          Create hero shots, lifestyle imagery, and marketing visuals instantly.
        </p>

        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl w-full mb-8">
          {[
            { title: "Photorealistic", desc: "4K quality renders" },
            { title: "Brand Consistent", desc: "Match your style guide" },
            { title: "Instant Export", desc: "Save to your library" },
          ].map((feature) => (
            <div 
              key={feature.title}
